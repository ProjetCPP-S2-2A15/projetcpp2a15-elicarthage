    ...
    : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    // Connexion des boutons - UNIQUEMENT cette méthode
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    connect(ui->ressourcesBtn, &QPushButton::clicked, this, [this]() {
        ui->widgetArchitecte->setVisible(false);
        ui->widgetRessources->setVisible(true);
    });


    connect(ui->architecteBtn, &QPushButton::clicked, this, [this]() {
        ui->widgetArchitecte->setVisible(true);
        ui->widgetRessources->setVisible(false);
    });
...
void MainWindow::modifierCellule(const QModelIndex &index)
{
    ...
    if (!newValue.isEmpty() && newValue != oldValue) {
        ...
        // [...] (gardez le reste de vos validations existantes)
        ...
        if (success) {
            ...
            // Si vous avez besoin de rafraîchir les stats
...
// Basculer vers le widget des ressources
// Basculer vers le widget des ressources
...
void MainWindow::switchWidget(QWidget* widgetToShow) {
    ...
    QList<QWidget*> mainWidgets = {
        ...
        ui->widgetProjet,
        ui->widgetClient,
        ui->widgetFormation// Nouveau widget ajouté
    };
...
*/
    ...
    QList<QPushButton*> navButtons = {
        ...
        ui->projetBtn,
        ui->clientBtn,
ui->formationsBtn       // Nouveau bouton ajouté
    };

    // Réinitialiser le style de tous les boutons
    QString defaultStyle = ""; // Style par défaut
    ...
    } else if (widgetToShow == ui->widgetClient) {  // Nouveau cas ajouté
...
// Ajoutez cette nouvelle méthode pour gérer le clic sur clientBtn
void MainWindow::on_clientBtn_clicked() {
    switchWidget(ui->widgetClient);
}
// Modifiez les gestionnaires de clic pour utiliser la nouvelle méthode
